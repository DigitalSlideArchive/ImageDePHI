...
export const useRedactionPlan = reactive({
  ...
  async updateImageData(directory: string, limit: number, offset: number, update: boolean) {
    this.imageRedactionPlan = await getRedactionPlan(directory, limit, offset, update);
  },
